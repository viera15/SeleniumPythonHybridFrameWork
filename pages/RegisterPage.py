...
class RegisterPage(BasePage):
    ...
    def enter_telephne(self,telephone_text):
    ...
    def register_an_account(self, first_name_text, last_name_text, email_text, telephone_text, password_text, confirm_password_text, yes_or_no, privacy_policy):
        ...
        self.enter_telephne(telephone_text)
    ...
    def retrieve_duplicte_email_warning(self):
    ...
    def verify_all_warnings(self, expected_privacy_policy_warning_message, expected_firstname_warning_message, expected_lastname_warning_message, expected_email_warning_message, expected_telephone_warning_message, expected_password_warning_message):
        ...
        if expected_privacy_policy_warning_message.__contains__(actual_privacy_policy_warning):
            if expected_firstname_warning_message.__eq__(actual_first_name_warning):
                if expected_lastname_warning_message.__eq__(actual_last_name_warning):
                    if expected_email_warning_message.__eq__(actual_email_warning):
