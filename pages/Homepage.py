...
class HomePage(BasePage):
    ...
    my_account_drop_down_xpath = "//span[contains(text(), 'My Account')]"
    login_option_link_text = "Login"
    register_option_link_text = "Register"

    def enter_product_into_search_box_field(self, product_name):
        # klikne na vyhľadávacie okienko, vymaže obsah, vpíše text
    ...
    def click_on_my_account_drop_menu(self):
        self.element_click("my_account_drop_down_xpath",self.my_account_drop_down_xpath)
